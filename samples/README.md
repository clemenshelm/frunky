...
- `oohs/` — `voice_oohs`, notes A3–E5 every minor third (the current voice)
- `choir/` — `choir_aahs`, notes A3–E5 every minor third (kept for future voice types)

Tone.Sampler pitch-shifts between the sampled notes.
